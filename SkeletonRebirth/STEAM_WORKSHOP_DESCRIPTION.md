...
[b]Your robots don't have to die for good — and some you could never recruit at all, now can be.[/b]

Vanilla Kenshi treats a defeated robot exactly like a dead human: gone, permanently, the instant it
...
[*] [b]Recruit races vanilla never lets you play.[/b] Once you're in Service Mode you can
[b]Reactivate[/b] the unit as-is, or wipe it to factory defaults with a full [b]Reset[/b] — every
skill and core stat back to 1, folded straight into your squad. That includes Iron Spiders,
...
just ones already in your squad, it also opens up races vanilla locks out of recruitment entirely —
an Iron Spider, Soldierbot Guard, or Security Spider you fight to a standstill doesn't have to stay
an enemy-only encounter.
